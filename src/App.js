...
export default function PersistentDrawerLeft() {
  ...
  const initialHomework = useMemo(() => ({id: 1, title: 'Vasya Petrov', description: 'text', users: [],
  deadLine: new Date()
}), [])
  const [homeWorkState, setHomeWorkState] = React.useState([initialHomework])
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route path="/homework">
            <Homework personName={personName} setPersonName={setPersonName} studentsState={studentsState} homeWorkState={homeWorkState} setHomeWorkState={setHomeWorkState} />
          </Route>
        </Switch>
      </main>
    </div>
